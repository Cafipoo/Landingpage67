...
import { ExternalLink, Github, Twitter, Instagram, Youtube } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <img src={mascot} alt="67 Adventure Mascot" className="w-16 h-16" />
                <div>
                  <h3 className="text-2xl" style={{ fontFamily: 'Syne, sans-serif' }}>67 Adventure</h3>
                  <p className="text-sm text-gray-400">Move. Play. Transform.</p>
                </div>
              </div>
              <p className="text-gray-400 text-sm mb-4">
                The revolutionary exergaming experience that turns fitness into an epic adventure.
              </p>
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-lg mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Quick Links</h4>
            ...
            {/* Resources */}
            <div>
              <h4 className="text-lg mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Resources</h4>
          ...
          <div className="border-t border-gray-700 pt-8 mb-8">
            <div className="bg-gradient-to-r from-[#8B7BA8] to-[#E97BA0] rounded-2xl p-8 text-center">
              <h4 className="text-2xl mb-3" style={{ fontFamily: 'Syne, sans-serif' }}>
          ...
          <div className="text-center text-sm text-gray-400 border-t border-gray-700 pt-8">
            ...
            <p className="mt-2">
              Powered by p5play, ML5.js, and MakeyMakey | Built with ❤️ and lots of movement
            </p>
          </div>
        </div>
      </div>
